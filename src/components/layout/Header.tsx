        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-3">
              {/* Logo Icon */}
              <div className="w-10 h-10 bg-neutral-500 rounded-lg flex items-center justify-center shadow-soft">
              ...
              <h1 className="text-xl lg:text-2xl font-bold text-neutral-900">
                ...
                <span className="text-neutral-600 text-lg lg:text-xl font-normal">, LLC</span>
              </h1>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Button
              ...
              className="shadow-soft hover:shadow-card bg-primary-600 hover:bg-primary-700"
            >
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center items-center">
              <span className={`block h-0.5 w-6 bg-neutral-600 transition-all duration-300 ${
                isMenuOpen ? 'rotate-45 translate-y-1' : ''
              }`} />
              <span className={`block h-0.5 w-6 bg-neutral-600 transition-all duration-300 mt-1 ${
            ...
            <nav className="py-4 space-y-2">
              {navigationItems.map((item) => (
                <button
                  key={item.id}
                  onClick={() => handleNavClick(item.href)}
                  className="block w-full text-left text-neutral-600 hover:text-primary-600 font-medium py-3 px-2 rounded-lg hover:bg-neutral-50 transition-colors duration-200"
                >
                  {item.label}
                </button>
              ))}
